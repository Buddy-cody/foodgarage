...
export default function ShopingComponent3()
{
          ...
          <section className="row mt-3">
            ...
            <aside className="col-4">
                ...
                <table className="table table-hover">
                  <thead>
                    <tr>
                        <th><input className="form-check-input"   id="flexCheckChecked" type="checkbox"  onClick={handleSelectAllFromCart}/></th>
                        <th>Title</th>
                        <th>Price</th>
                        <th>Preview</th>
                    </tr>
                  ...
                  <tbody>
                    {
                        cartItems.map(item=>
                            <tr key={item.id}>
                                <td><input className="form-check-input"   id={item.id} /></td>
                                <td>{item.title}</td>
                                <td>{item.price}</td>
                                <td>
                                ...
                                <td>
                                    <button id={item.id} onClick={handleDeleteFromCart} className="btn btn-danger">
